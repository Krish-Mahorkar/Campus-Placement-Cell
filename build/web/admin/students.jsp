        ...
        <div class="container">
            ...
            <div class="row" style=" margin-top: 20px;">
                ...
                <div class="col-md-9" style="padding: 0px">
                    <h3 style="margin: 0px; color:#fff; background-color: #f3974e; border-top-left-radius: 4px; border-top-right-radius: 4px; padding: 8px;">STUDENTS </h3>
                    <div style="border:1px solid #ddd; width: 100%; padding: 8px; display: inline-block;" class="text-justify">
                        <table class="table table-bordered table-striped table-hover table-responsive">
                            <thead>
                                <tr><th>Sr.No.</th><th>Full name</th><th>Contact no</th><th>Email ID</th><th>Branch</th><th>Enroll. no</th><th>Address</th><th>Year</th></tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                if(rs!=null){
                                    ...
                                    while(rs.next()){
                                %>
                                <tr><th><%=i++%></th><th><%=rs.getString("fullname")%></th><th><%=rs.getString("mobileno")%></th><th><%=rs.getString("email")%></th><th><%=rs.getString("branch")%></th><th><%=rs.getString("enrolno")%></th><th><%=rs.getString("address")%></th><th><%=rs.getString("year")%></th>
